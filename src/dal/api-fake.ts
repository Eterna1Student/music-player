...
import type {GetTrackDetailOutput, GetTrackOutput} from "./api.ts";

export const getTrack = (trackId: string) => {
    const promise: Promise<GetTrackDetailOutput> = Promise.resolve({
        "data": {
...
export const getTracks = () => {
    const promise: Promise<GetTrackOutput> = Promise.resolve({
        "data": [
            {
                "id": "40941736-77b7-4bb0-b3b2-ca1e31e1f4a6",
                "type": "tracks",
